...
/**
 * Root event log for the demo. Feature actions append timestamped messages that
 * the on-page log panel renders newest-first, giving a visible trace of every
 * SDK interaction the demo performs.
 */
